...
builds:
  build:
    ...
    cache:
      ...
      "/usr/lib/librocksdb.so.6.23.3": "/usr/lib/librocksdb.so.6.23.3"
  pack:
    base: harbor.shopeemobile.com/cloud/aws-sdk-cpp:1.9.31
    commands:
      - >
        ...
        ln -s /usr/lib/librocksdb.so.6.23.3 /usr/lib/librocksdb.so.6.23 &&
        ln -s /usr/lib/librocksdb.so.6.23.3 /usr/lib/librocksdb.so.6 &&
        ln -s /usr/lib/librocksdb.so.6.23.3 /usr/lib/librocksdb.so
EOF
